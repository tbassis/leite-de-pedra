...
} from "file:///Users/tulioassis/Dev/frontend/leite-de-pedra/node_modules/h3/dist/index.mjs";
import {
	getRequestDependencies,
	getPreloadLinks,
	getPrefetchLinks,
	createRenderer,
} from "file:///Users/tulioassis/Dev/frontend/leite-de-pedra/node_modules/vue-bundle-renderer/dist/runtime.mjs";
import {
	stringify,
	uneval,
} from "file:///Users/tulioassis/Dev/frontend/leite-de-pedra/node_modules/devalue/index.js";
...
} from "file:///Users/tulioassis/Dev/frontend/leite-de-pedra/node_modules/ofetch/dist/node.mjs";
import destr from "file:///Users/tulioassis/Dev/frontend/leite-de-pedra/node_modules/destr/dist/index.mjs";
import {
	createCall,
	createFetch,
} from "file:///Users/tulioassis/Dev/frontend/leite-de-pedra/node_modules/unenv/runtime/fetch/index.mjs";
...
import defu, {
	defuFn,
} from "file:///Users/tulioassis/Dev/frontend/leite-de-pedra/node_modules/defu/dist/defu.mjs";
...
import {
	...
	getQuery,
	withQuery,
} from "file:///Users/tulioassis/Dev/frontend/leite-de-pedra/node_modules/ufo/dist/index.mjs";
import {
	createStorage,
	prefixStorage,
} from "file:///Users/tulioassis/Dev/frontend/leite-de-pedra/node_modules/unstorage/dist/index.mjs";
...
import {
	toRouteMatcher,
	createRouter,
} from "file:///Users/tulioassis/Dev/frontend/leite-de-pedra/node_modules/radix3/dist/index.mjs";
import {
	version,
	unref,
} from "file:///Users/tulioassis/Dev/frontend/leite-de-pedra/node_modules/vue/index.mjs";
...
storage.mount(
	...
	unstorage_47drivers_47fs({
		driver: "fs",
		readOnly: true,
		base: "/Users/tulioassis/Dev/frontend/leite-de-pedra",
...
storage.mount(
	...
	unstorage_47drivers_47fs({
		driver: "fs",
		readOnly: true,
		base: "/Users/tulioassis/Dev/frontend/leite-de-pedra/server",
		ignore: ["**/node_modules/**", "**/.git/**"],
	}),
);
storage.mount(
	...
	unstorage_47drivers_47fs({
		driver: "fs",
		readOnly: false,
		base: "/Users/tulioassis/Dev/frontend/leite-de-pedra/.nuxt",
		ignore: ["**/node_modules/**", "**/.git/**"],
	}),
);
storage.mount(
	...
	unstorage_47drivers_47fs({
		driver: "fs",
		readOnly: false,
		base: "/Users/tulioassis/Dev/frontend/leite-de-pedra/.nuxt/cache",
		ignore: ["**/node_modules/**", "**/.git/**"],
	}),
);
storage.mount(
	...
	unstorage_47drivers_47fs({
		driver: "fs",
		base: "/Users/tulioassis/Dev/frontend/leite-de-pedra/.data/kv",
		ignore: ["**/node_modules/**", "**/.git/**"],
	}),
);
...
const getClientManifest = () =>
	import(
		"file:///Users/tulioassis/Dev/frontend/leite-de-pedra/.nuxt/dist/server/client.manifest.mjs"
	)
		.then(r => r.default || r)
		.then(r => (typeof r === "function" ? r() : r));
const getServerEntry = () =>
	import(
		"file:///Users/tulioassis/Dev/frontend/leite-de-pedra/.nuxt/dist/server/server.mjs"
	).then(r => r.default || r);
